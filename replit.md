...
- **3D Box Labels**: CanvasTexture applied as material on all six faces of each box showing name, dimensions, and weight (transparent background, white text with dark shadow for contrast)
