...
test.describe("tool pages load without runtime errors", () => {
  ...
  test("Container Calculator — 3D viewer and controls mount", async ({ page }) => {
    ...
    if (await page.getByTestId("button-arrange-cargo").count()) {
      ...
      await expect(page.getByTestId("container-command-bar")).toBeVisible();
      ...
      await expect(page.getByTestId("button-keyboard-shortcuts")).toBeVisible();
      ...
      await page.getByTestId("button-container-help").click();
      await page.getByTestId("button-share-scene").click();
      await expect(page.getByTestId("container-share-panel")).toBeVisible();
      await expect(page.getByTestId("button-share-email")).toBeVisible();
      await expect(page.getByTestId("button-share-facebook")).toBeVisible();
      await expect(page.getByTestId("button-share-linkedin")).toBeVisible();
      await expect(page.getByTestId("button-share-whatsapp")).toBeVisible();
      await page.getByTestId("button-share-scene").click();
      await page.getByTestId("button-toggle-placement-summary").click();
      await expect(page.getByTestId("viewer-placement-summary")).toBeVisible();
      await page.getByTestId("button-toggle-viewer-balance").click();
      await expect(page.getByTestId("viewer-balance-summary")).toBeVisible();
      ...
      await page.getByTestId("button-stage-dock1-0").click();
      await expect(page.getByTestId("button-cargo-zone-dock1")).toContainText("1");
